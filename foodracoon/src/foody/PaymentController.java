...
public class PaymentController implements Initializable {
   ...
   // public static int ze;
    ...
    public void confirmPayment(ActionEvent event) throws InterruptedException{
         try {
             if(paymentModel.isPaymentOnline()){
                 ...
                 infoBox1("Order Confirmed",null, "Success");
                  try {
                        ...
                        primaryStage.setTitle("Welcome To Food Racoon Menu");
                        Scene scone = new Scene(root);
                        primaryStage.setScene(scone);
